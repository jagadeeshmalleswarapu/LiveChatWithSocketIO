...
app = Flask(__name__)
app.config['SECRET_KEY'] = 'dsgfdnio'
...
def home():
    ...
    if request.method == 'POST':
        ...
        if not name:
            return render_template("home.html", error='Name should not be empty.', code=code, name=name)
...
if __name__ == '__main__':
    socketio.run((app.run(debug=True)), debug=True)
